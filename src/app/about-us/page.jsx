  ...
  return (
    <>
      ...
      <main className='max-w-4xl mx-auto px-6 py-12 text-center'>
        ...
        <p className='text-lg mb-4'>
          PhillsPhanbh3 my lead developer didn’t know where to begin, but with
          the help of 2 talented coder friends, Jeo and Ziggy, the project began
          to take off.
        </p>
        <p className='text-lg mb-4'>
        ...
        <p className='text-lg mb-6 font-semibold text-orange-300'>
          Our goal is to provide server admins with powerful tools to keep their
          communities safe and enjoyable for all members, and to possibly become
          a competitor to popular bots like MEE6, Dyno, and Carl-bot.
        </p>

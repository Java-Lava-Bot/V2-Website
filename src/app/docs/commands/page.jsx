...
const commandCategories = [
  {
    ...
    commands: [
      ...
      },
      {
        ...
        permissions: 'Ban Members',
        examples: ['/infractions @user'],
      },
      {
        name: '/logs',
        description: 'Setup logs channel for moderation actions',
        usage: '/logs [channel]',
        permissions: 'Manage Channels',
        examples: ['/logs #logs', '/logs' ],
      },
      {
        name: '/mod-logs',
        description: 'Setup a dedicated moderation logs channel',
        usage: '/mod-logs [channel]',
        permissions: 'Manage Channels',
        examples: ['/mod-logs #mod-logs', '/mod-logs' ],
      },
      {
        name: '/mod-notes',
        description: 'Setup a dedicated moderator notes channel',
        usage: '/mod-notes [channel]',
        permissions: 'Manage Channels',
        examples: ['/mod-notes #mod-notes', '/mod-notes' ],
      },
      {
        name: '/report',
  ...
  },
  {
    ...
    commands: [
      ...
      {
        name: '/study-set-key',
        description: 'DM\'s ONLY COMMAND - Add your gemini api key for unlimited use of the study buddy feature!',
        usage: '/study-set-key <your_gemini_api_key>',
        permissions: 'DM\'s with Bot',
        examples: ['/study-set-key <your_gemini_api_key>'],
      },
      {
        name: '/study-remove-key',
        description: 'DM\'s ONLY COMMAND - Deletes your Gemini API key from the bot database.',
        usage: '/study-remove-key',
        permissions: 'DM\'s with Bot',
        examples: ['/study-remove-key'],
      },
    ],
  },
];

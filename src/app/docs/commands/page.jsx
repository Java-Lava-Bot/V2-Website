  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        name: '/study-set-key',
        description:
          "DM's ONLY COMMAND - Add your gemini api key for unlimited use of the study buddy feature!",
      ...
      },
      {
        ...
        description:
          "DM's ONLY COMMAND - Deletes your Gemini API key from the bot database.",

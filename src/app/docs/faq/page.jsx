...
const faqData = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          'Java Lava is currently on version 2.3! This version includes a complete rewrite with improved performance and new features. Check our updates section for detailed changelog information.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          'Version 2.3 is a WHOLE rewrite of Java Lava, featuring a new architecture, improved performance, and a host of new features! (2.3 fixed bugs)',
        link: {
          text: 'View Changelog',
          url: '/docs/updates',
        }

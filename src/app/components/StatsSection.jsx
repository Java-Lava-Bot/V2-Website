...
export default function StatsSection() {
  ...
  const stats = [
    { value: '70+', label: 'Servers' },
    { value: '4.5k+', label: 'Users' },
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-[#1a1a2e] border border-[var(--color-primary)] border-opacity-20 rounded-xl p-6">
            <div className="flex items-center mb-4">
              ...
              <h4 className="text-xl font-semibold ml-3">
          ...
          <div className="bg-[#1a1a2e] border border-[var(--color-primary)] border-opacity-20 rounded-xl p-6">
            ...
            <p className="text-gray-400">
              Our dedicated support team is always ready to help with any issues
              or questions. Premium users enjoy priority support with response

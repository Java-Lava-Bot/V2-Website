  ...
  const premiumFeatures = [
    {
      ...
      description:
        'Access to premium-only commands and features that enhance your server experience.',
    },
    {
      icon: <RocketLaunchIcon className="h-6 w-6" />,
      title: 'Priority Support',
      description:
        'Get faster responses from our dedicated support team when you need assistance.',
    },
    {
            ...
            <div className="p-8 md:p-12">
              ...
              >
                ...
                <p className="text-gray-400 mb-8">
                  Unlock the full potential of Java Lava with our premium
                  features. Enhance your server's capabilities and provide a

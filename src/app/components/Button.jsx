...
export default function Button({
  ...
  const baseStyle =
    'font-bold px-8 py-4 rounded-lg text-xl shadow-lg transition duration-300 flex items-center justify-center gap-2 text-white';
  ...
  const colorVariants = {
    ...
    accent:
      'bg-[var(--color-accent)] hover:bg-opacity-90 text-[var(--color-dark)]',
    dark: 'bg-[var(--color-dark)] border border-[var(--color-primary)] hover:bg-[var(--color-primary)] hover:bg-opacity-20',
    outline:
      'border-2 border-[var(--color-primary)] text-[var(--color-primary)] hover:bg-[var(--color-primary)] hover:bg-opacity-10',
  };

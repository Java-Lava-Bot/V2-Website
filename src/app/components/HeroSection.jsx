        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              ...
              >
                <svg xmlns="https://discord.com/oauth2/authorize?client_id=1305190785536360519" className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 640 512">
                ...
                <div className="p-6">
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <div className="bg-[var(--color-accent)] bg-opacity-10 p-4 rounded-lg">
                      <div className="text-xs text-Black-400 mb-1">Commands Used</div>

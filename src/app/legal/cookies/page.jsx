            ...
            <div className='bg-gray-900/30 rounded-2xl p-8 border border-gray-800/50 space-y-8'>
              <section>
                ...
                <p className='text-gray-300 leading-relaxed'>
                  ...
                  https://betajavalava.phillsphanbh3.me/ ("Website"). This
                  policy explains what these technologies are and why we use
                  them, as well as your rights to control our use of them. WE
                  WILL NEVER USE COOKIES TO STORE PERSONAL DATA WITHOUT YOUR
                  CONSENT. By using our Website, you consent to the use of
              ...
              <section>
                ...
                <p className='text-gray-300 leading-relaxed'>
                  ...
                  through the website (e.g. our status page embed provided by
                  Statuspage.io). The parties that set these third party cookies
              ...
              <section>
                ...
                <p className='text-gray-300 leading-relaxed'>
                  ...
                  "strictly necessary" cookies. Other cookies also help us
                  analyze and understand how our Website is used, what features
                  and functionality are popular, and improve the experience for
                  visitors. The specific types of first and third party cookies
              ...
              <section>
                ...
                <p className='text-gray-300 leading-relaxed'>
                  ...
                  are strictly necessary to provide you with services. The
                  Cookie Consent Manager can be found in the notification banner
                  and on our Website. If you choose to reject cookies, you may
                  still use our Website though your access to some functionality
                  and areas of our Website may be restricted. You may also set
                  or amend your web browser controls to accept or refuse
                  cookies. Please note that if you reject cookies, you may not
                  be able to use all of the features we offer, you may not be
                  able to store your preferences, and some of our pages may not
                  display properly.
                </p>
              </section>
              ...
              <section>
                <h2 className='text-2xl font-bold text-[var(--color-policies)] mb-4'>
                  6. What cookies is being used to track me/be shown on the
                  website?
                </h2>
                <p className='text-gray-300 leading-relaxed mb-4'>
                  We have implemented the following cookies on our Website due
                  to our statuspage embed:
                </p>
                <ul className='list-disc list-inside text-gray-300 space-y-2'>
                  <li>Name: s7</li>
                  <li>
                    Purpose: Gather data regarding site usage and user behavior
                    on the website.
                  </li>
                  <li>Provider: f2s16vld08pq.statuspage.io</li>
                  <li>Service: Adobe Analytics</li>
                  <li>Type: html_local_storage</li>
                  <li>Expires in: persistent</li>
                </ul>
                <p className='text-gray-300 leading-relaxed mb-4'></p>
                <p className='text-gray-300 leading-relaxed mb-4'>
                  We also do route our website traffic through Cloudflare, which
                  may set cookies for security and performance purposes. For
                  more information on Cloudflare's cookie usage, please visit
                  their{' '}
                  <a

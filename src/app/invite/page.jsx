...
export default function NotFound() {
  ...
  useEffect(() => {
    ...
    if (count === 0) {
      window.location.href =  'https://discord.com/oauth2/authorize?client_id=1305190785536360519&permissions=8&response_type=code&redirect_uri=https%3A%2F%2Fjavalava.phillsphanbh3.me%2F&integration_type=0&scope=identify+guilds+guilds.join+bot';
    }
